...
export default class CallManager  {
    ...
    closeCallOutConnection (callOut,originCallerTopic,deleteCallOut=true)  {
        if(callOut!=null){
    ...
    closeCallInConnection (callIn,originCallerTopic,deleteCallIn=true)  {
        if(callIn!=null){
